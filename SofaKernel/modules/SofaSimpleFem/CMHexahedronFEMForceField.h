...
public:
	...
	{
		core::topology::BaseMeshTopology::HexahedraAroundVertex liste_hexa = _topology->getHexahedraAroundVertex(nodeIdx);
		...
		//		_mesh->foreach_incident_volume(Vertex(nodeIdx), [&](Volume v){
		//			Transformation R0t;
