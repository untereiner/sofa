...
macro(CGOGN_CHECK_FOR_SSE)
    ...
    if(NOT MSVC)
        ...
        elseif(HAVE_SSE3_EXTENSIONS)
            SET(CGOGN_SSE_FLAGS "${CGOGN_SSE_FLAGS} -msse3 -mfpmath=sse")
		...
		if(NOT CMAKE_CL_64)
			if(HAVE_SSE2_EXTENSIONS)
				set(CGOGN_SSE_FLAGS "${CGOGN_SSE_FLAGS} /arch:SSE2")
			elseif(HAVE_SSE_EXTENSIONS)
				set(CGOGN_SSE_FLAGS "${CGOGN_SSE_FLAGS} /arch:SSE")
			endif()
		endif()
        if(HAVE_SSSE3_EXTENSIONS)
            SET(CGOGN_SSE_DEFINITIONS "${CGOGN_SSE_DEFINITIONS} -D__SSSE3__")
        endif()
        if(HAVE_SSE2_EXTENSIONS)
            SET(CGOGN_SSE_DEFINITIONS "${CGOGN_SSE_DEFINITIONS} -D__SSE2__")
        endif()
        if(HAVE_SSE_EXTENSIONS)
            SET(CGOGN_SSE_DEFINITIONS "${CGOGN_SSE_DEFINITIONS} -D__SSE__")
        endif()
    endif()
endmacro(CGOGN_CHECK_FOR_SSE)
...
set(${result} ${HAVE_SSE4_2_EXTENSIONS})
endfunction()
...
set(${result} ${HAVE_SSE4_1_EXTENSIONS})
endfunction()
...
set(${result} ${HAVE_SSE3_EXTENSIONS})
endfunction()
...
set(${result} ${HAVE_SSE2_EXTENSIONS})
endfunction()
...
if (HAVE_SSE_EXTENSIONS)
	message(STATUS "sse1 support detected.")
endif()

set(${result} ${HAVE_SSE_EXTENSIONS})
endfunction()